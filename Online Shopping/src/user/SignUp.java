...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "What is your favorite color?", "What is your family name?", "What is first school name?", "What is your school name?", "What was your first car?", " " }));
        ...
        if (isEmpty()) {
            ...
            if (!user.isEmailExist(email)) {
                if (!user.isPhoneExist(phone)) {
                    ...
                    JOptionPane.showMessageDialog(this, "This phone number already exits", "Warning", 2);
                }
            } else {
                JOptionPane.showMessageDialog(this, "This email address already exits", "Warning", 2);
            }
        }
